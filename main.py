...
# 最新情報は https://indexes.nikkei.co.jp/nkave/index/component?idx=nk225 等でご確認ください。
NIKKEI_225_TICKERS = [
...
# 2024年6月時点の東証グロース市場250指数 全採用銘柄リスト (約250銘柄)
...
def get_stock_data(tickers, file_path, index_name):
    ...
    if start_date > end_date:
        print(f"INFO: {index_name} のデータは最新です（前日分まで取得済み）。")
        return
        
    print(f"INFO: yfinanceで {start_date} から {end_date} までのデータをダウンロードします...")
